...
st.set_page_config(page_title="Automatic Diet Recommendation", page_icon="🍽️",layout="wide")
...
with st.form("recommendation_form"):
    st.write("Click the Generate button after making changes to the below values.")
